...
class UsProxyCrawler extends BaseCrawler implements ProxyRepositoryInterface
{
    /**
    ...
    public function getProxies()
    {
        $proxies = [];
        try {
            $crawler = $this->getCrawler('https://www.us-proxy.org/', true);
        } catch (ConnectException $e) {
            $this->logger->error(
                'We can not connect to "https://www.us-proxy.org", please check your connection',
                [
                    'repository' => 'us-proxy',
        ...
        $this->logger->info('Fetch {count} proxy from us-proxy.org', ['count' => count($proxies)]);
