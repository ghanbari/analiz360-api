            ...
            ->andWhere($qb->expr()->orX(
                ...
                $qb->expr()->andX(
                    ...
                    CASE
                        ...
                        WHEN d.score > 9 THEN DATEADD(DATE(d.lastReportAt), 2, 'DAY')
                        WHEN d.score > 5 THEN DATEADD(DATE(d.lastReportAt), 3, 'DAY')
                        WHEN d.score > 2 THEN DATEADD(DATE(d.lastReportAt), 4, 'DAY')
                        WHEN d.score > 1 THEN DATEADD(DATE(d.lastReportAt), 5, 'DAY')
                        WHEN d.score > 0 THEN DATEADD(DATE(d.lastReportAt), 6, 'DAY')
